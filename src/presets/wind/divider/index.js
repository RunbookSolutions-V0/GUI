export default {
  root: ({ props }) => ({
    class: [
      ...
      // Color
      {
        'before:border-t before:border-background-200 before:dark:border-background-600':
          props.layout == 'horizontal',
        'before:border-l before:border-background-200 before:dark:border-background-600':
          props.layout == 'vertical'
      }
    ]
  }),
