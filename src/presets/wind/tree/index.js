export default {
  ...
  content: ({ context, props }) => ({
    class: [
      ...
      {
        'bg-background-100 text-primary-500 dark:bg-background-300/10 dark:text-primary-400':
          context.selected
      },

      // States
      {
        'hover:bg-background-200 dark:hover:bg-background-400/10':
  ...
  loadingicon: {
    class: [
      'text-background-500 dark:text-background-0/70',
