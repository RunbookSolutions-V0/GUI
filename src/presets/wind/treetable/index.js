  ...
  headercell: ({ context, props }) => ({
    class: [
      ...
      (props.sortable === '' || props.sortable) && context.sorted
        ...
        : 'dark:text-white/80 dark:bg-background-800',
      'border-background-200 dark:border-background-700 ',
  ...
  column: {
    ...
    sorticon: ({ context }) => ({
      class: [
        ...
        context.sorted
          ...
          : 'fill-background-700 dark:fill-white/70'
      ]
    }),
    sortbadge: {
      class: [
    ...
    checkbox: ({ context }) => ({
      class: [
        ...
        'text-background-600',
        {
          'border-background-200 bg-background-0 dark:border-background-700 dark:bg-background-900':
            !context.checked,
