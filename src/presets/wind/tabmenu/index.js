export default {
    ...
    action: ({ context, state }) => ({
        class: [
            ...
            {
                'hover:bg-background-0 dark:hover:bg-background-700/80': state.d_activeIndex !== context.index,
                'hover:border-background-400 dark:hover:border-background-500': state.d_activeIndex !== context.index,
                'hover:text-background-900 dark:hover:text-background-0': state.d_activeIndex !== context.index
            },
