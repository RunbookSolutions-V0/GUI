export default {
  ...
  inputicon: {
    class: [
      ...
      'text-background-600 dark:text-background-200',
      'right-[.75rem]'
    ]
  },
  dropdownbutton: {
  ...
  weekheader: {
    class: [
      ...
      'text-background-600 dark:text-white/70',
  ...
  weeklabelcontainer: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        'text-background-600 dark:text-white/70 bg-transparent':
  ...
  daylabel: ({ context }) => ({
    class: [
      ...
      // Colors
      {
        'text-background-0 bg-background-900 dark:text-background-900 dark:bg-background-0':
          context.date.today && !context.selected && !context.disabled,
        'text-background-600 dark:text-white/70 bg-transparent':
          !context.selected && !context.disabled && !context.date.today,
        'text-primary-500 dark:text-primary-400':
          context.selected && !context.disabled && !context.date.today,
        'text-primary-200 dark:text-primary-600 bg-background-900 dark:bg-background-0':
          context.selected && !context.disabled && context.date.today
      },
      ...
      'focus:outline-none focus:outline-offset-0 focus:ring-1 focus:ring-primary-500 dark:focus:ring-primary-400',
      {
        ...
        'hover:bg-background-700 dark:hover:bg-background-200':
