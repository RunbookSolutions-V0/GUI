  ...
  root: ({ props, context, parent }) => ({
    class: [
      ...
      // Secondary Button
      {
        ...
        'bg-background-500 dark:bg-background-400':
          props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
        'ring-1 ring-background-500 dark:ring-background-400':
          props.severity === 'secondary' && !props.text && !props.outlined && !props.plain
      },
      // Secondary Text Button
      {
        'text-background-500 dark:text-background-400':
          props.text && props.severity === 'secondary' && !props.plain
      },
      // Secondary Outlined Button
      {
        'text-background-500 ring-1 ring-background-500 hover:bg-background-300/20':
      ...
      // Secondary
      {
        'hover:bg-background-600 dark:hover:bg-background-300 hover:ring-background-600 dark:hover:ring-background-300':
          props.severity === 'secondary' && !props.text && !props.outlined && !props.plain
      },
      {
