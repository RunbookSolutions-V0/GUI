export default {
  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        (props.sortable === '' || props.sortable) && context.sorted
          ? 'text-primary-500'
          : 'bg-background-0 text-background-700',
        (props.sortable === '' || props.sortable) && context.sorted
          ? 'dark:text-primary-400'
          : 'dark:text-white/80 dark:bg-background-700',
        'border-background-200 dark:border-background-600 ',
    ...
    sort: ({ context }) => ({
      class: [
        context.sorted ? 'text-primary-500' : 'text-background-700',
    ...
    filterrowitem: ({ context }) => ({
      class: [
        ...
        {
          'bg-background-0 dark:bg-background-700 text-background-700 dark:text-white/80':
            !context?.highlighted
        },
        {
    ...
    radiobutton: ({ context }) => ({
      class: [
        ...
        {
          'ring-2 ring-offset-2 ring-offset-background-0 dark:ring-offset-background-800 ring-primary-500 dark:ring-primary-400':
            context.focused
        },
    ...
    headercheckbox: ({ context }) => ({
      class: [
        ...
        'text-background-600',
        {
          'border-background-300 bg-background-0 dark:border-background-600 dark:bg-background-800':
            !context.checked,
  ...
  bodyrow: ({ context, props }) => ({
    class: [
      ...
      {
        'odd:bg-background-0 odd:text-background-600 dark:odd:bg-background-800 even:bg-background-50 even:text-background-600 dark:even:bg-background-900/60':
      ...
      {
        'hover:bg-background-300/20 hover:text-background-600':
  ...
  rowgroupheader: {
    class: [
      'sticky z-20',
      'bg-background-0 text-background-600 dark:text-white/70',
